...
```bash
curl "https://api.wenwen-ai.com/v1/messages" \
...
**The native upstream (https://api.wenwen-ai.com) does not support claude-4.5-sonnet**

This is an **upstream limitation**, not a proxy bug. The proxy is working correctly:
- ✅ Routing is correct: `https://api.wenwen-ai.com/v1/messages`
...
### Native Mode (https://api.wenwen-ai.com)
...
|---------------|--------------|-------|
| Native mode (api.wenwen-ai.com) | 0% | Model not available on upstream |
