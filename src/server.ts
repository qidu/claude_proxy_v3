...
const env: NodeEnv = {
  ...
  VERIFIER_SIDECAR_IPS: process.env.VERIFIER_SIDECAR_IPS,
  VERIFIER_TIMEOUT_MS: process.env.VERIFIER_TIMEOUT_MS,
  VERIFIER_CALL_MARGIN: process.env.VERIFIER_CALL_MARGIN,
  VERIFIER_FAIL_OPEN: process.env.VERIFIER_FAIL_OPEN,
  VERIFIER_CRITERIA: process.env.VERIFIER_CRITERIA,
};
