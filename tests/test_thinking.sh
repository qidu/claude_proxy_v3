...
test_endpoint() {
  ...
  RESP=$(timeout 20 curl -s "$url" -H "Content-Type: application/json" -d "$data")
...
COMPLEX_Q="Explain step by step how to solve: A train travels 120 km in 2 hours, then 180 km in 3 hours. What is the average speed?"
...
echo "Thinking Models Test Suite"
echo "==========================="
echo "Testing ${#MODELS[@]} models - Non-Stream & Stream"
echo
